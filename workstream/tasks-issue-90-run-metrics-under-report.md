...
- [x] 1.0 Implement Issue #90 — https://github.com/llipe/dev-tasks-agent-fleet/issues/90: Fix run-metric under-reporting of changed packages and fixed advisories
  ...
  - [ ] 1.cc E2E note: "Verified by a real E2E run on a monorepo repository" requires live AWS/Supabase/GitHub access — documented as an operator-run step (mirrors issue #77 runbook handling); not runnable in this environment.
