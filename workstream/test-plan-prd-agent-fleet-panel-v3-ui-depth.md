...
- **Tasks** (`workstream/archive/tasks-prd-agent-fleet-panel-v3-ui-depth-plan.md`, archived — all 7 stories shipped): execution checklist, 7 top-level tasks (1.0–7.0) mapped 1:1 to S-142–S-148 and issues #202–#208.
