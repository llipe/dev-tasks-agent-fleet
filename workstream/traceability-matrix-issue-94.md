...
- **ACs pending:** 2 / 7 — **AC5** (blocked by [#98](https://github.com/llipe/dev-tasks-agent-fleet/issues/98); use the synthetic interlock proof in runbook §4.4) and **AC6** (Task 5 not executed).
