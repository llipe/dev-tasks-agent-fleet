...
/**
 * Run filter controls — S-020.
 *
 * Client component for status dropdown and date range presets.
 * Writes filters to URL search params via shallow navigation.
 */
...
export function RunFilters({ agentName, filters }: RunFiltersProps) {
...
function getActivePresetDays(filters: ParsedRunFilters): number | null {
  ...
  // Allow ±1 hour tolerance for "now" drift
