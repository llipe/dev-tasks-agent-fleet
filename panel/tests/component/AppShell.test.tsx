...
describe("AppShell — structure and a11y (AC1, AC3, AC5)", () => {
  ...
  it("marks Agents and All runs as enabled destinations; the remaining three deferred are disabled (S-146, FR14)", () => {
    render(<AppShell>{child()}</AppShell>);
    ...
    // The remaining three deferred destinations are NOT links.
